...
const {checkProjectExists, getBeneficiaries, getProjectLogo, findProject} = require('./projectFind')
...
projectRouter
    ...
    .all(jwtCheck)
    .get(
        checkProjectExists, checkProjectRead, getBeneficiaries, getProjectLogo,
        findProject
    )
    .patch(
